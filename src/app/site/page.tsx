...
export default function Home() {
  return (
    <>
      <section className="h-full w-full md:pt-44 lg:pt-96 relative flex items-center justify-center flex-col ">
        {/* grid */}
        ...
        <div className="flex justify-center items-center relative md:mt-[-20px] lg:mt-[-10px]">
          <Image
      ...
      <section className="flex justify-center items-center flex-col gap-4 mt-[-40px] md:mt-52 lg:mt-96">
